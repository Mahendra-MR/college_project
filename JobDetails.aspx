<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobDetails.aspx.cs" Inherits="NcbJobPortal.User.JobDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <main>
        ...
        <!-- Hero Area End -->
         ...
         <div>
         <asp:Label ID="lblMsg" runat="server" visibe="false"></asp:Label>
         </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                         ...
                         <div class="apply-btn2">
                          ...
                          <asp:LinkButton ID="lbApplyJob" runat="server" CssClass="btn" Text="Apply Now" CommandName="ApplyNow"></asp:LinkButton>
                         </div>
                       </div>
