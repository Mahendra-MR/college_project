<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="NcbJobPortal.User.Profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container pt-5 pb-5">
        <div class="main-body">
            <asp:DataList ID="dlProfile" runat="server" OnItemCommand="dlProfile_ItemCommand" Width="100%">
                <ItemTemplate>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <<img src="../Images/user_pic.png" alt="UserPic" class="rounded-circle" 
                                            width="150"/>
                                        <div class="mt-3">
