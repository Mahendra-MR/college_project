<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Newjob.aspx.cs" Inherits="NcbJobPortal.Admin.Newjob" %>
...
background-size:cover; background-attachment:fixed;">
        <div class="container pt-4 pb-4"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
             ...
             <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex. MCA,BTech,BE,MBA,BCA" required></asp:TextBox>
                </div>
                 <div class="col-md-6 pt-3">
                    <label for="txtExperience" style="font-weight:600">Experience Required</label>
                     <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex. 2 Years, 0-1 Years"
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
              ...
              <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex. 25k/Month, 7L/Year" 
                     required></asp:TextBox>
                </div>
                 <div class="col-md-6 pt-3">
                    <label for="ddlJobType" style="font-weight:600">JOb Type</label>
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator" runat="server" ErrorMessage="Job Type Is Required" ForeColor="Red"
              ...
              <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtCompany" runat="server" CssClass="form-control" placeholder="Company/Organisation Name" 
                     required></asp:TextBox>
                </div>
                 <div class="col-md-6 pt-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-12 pt-3">
                    <label for="txtAddress" style="font-weight:600">Organizartion Address</label>
              ...
              <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtCompany" style="font-weight:600">Country</label>
                    <asp:DropDownList ID="ddlCountry" runat="server" DataSourceID="SqlDataSource1" CssClass="form-contact w-100" 
                         AppendDataBoundItems ="true" DataTextField="CountryName" DataValueField="CountryName">
                         <asp:ListItem Value="0">Select Country</asp:ListItem> </asp:DropDownList>
            ...
            <div class="col-md-3 col-md-offse-2 mb-3">
